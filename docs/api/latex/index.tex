...
If you would like to use M\+A\+G\+M\+A for solvers, you need to modify the cmake argument with the path to the M\+A\+G\+M\+A installation. Your configuration statement should look like the following\+:
